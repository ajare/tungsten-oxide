// src/app/main.cpp — a minimal native command-line host
...
// playable client — see src/README.md and NATIVE_GAME_RUNTIME_PLAN.md §2.7/§4
// for what deliberately stays outside src/core and this executable.
#include <chrono>
#include <cstdio>
#include <iostream>
#include <memory>
...
// the native build is documented as an MSVC/Windows target (src/README.md);
