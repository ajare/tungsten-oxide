...
// src/core/include/TrackDefinition.hpp.
//
...
// UI selection hint), add it here, not in src/core/include/TrackDefinition.hpp — core's copy stays
...
// owns both JSON directions independently of src/core (see fromJson/toJson below), so core's loader
...
// migration lives here or in src/core).
