...
// src/core's tox::Track loader (see EditorTrackDefinition.hpp for why). JSON field names and
// defaults are kept in lockstep with src/core/src/TrackLoader.cpp's normalize() -- that is the
