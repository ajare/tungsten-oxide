...
// CENTRAL_RESERVATION_PLAN.md M0: the committed golden fixture corpus under src/test-data/ is
...
// several fixtures in the committed golden corpus (src/test-data/) depend on its exact floating-
