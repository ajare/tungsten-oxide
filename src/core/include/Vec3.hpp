...
// Vec3 with a specific operation order pinned to the golden fixture corpus (src/test-data/); it has
// been migrated to glm, so physics now uses glm's normalize/cross/quaternion-rotation implementations
// directly. Fixture tolerances were loosened accordingly — see src/test-data/traces/README.md.
#pragma once
