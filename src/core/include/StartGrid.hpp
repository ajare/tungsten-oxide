// StartGrid.hpp — pure racing-grid layout plus the authored-start settling pass
// (startingGridPoses). Longitudinal offsets are positive distances behind the
...
// settled onto the same sampled curved surface physics uses.
