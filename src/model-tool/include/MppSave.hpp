...
// (not a from-scratch byte writer like src/editor's MppModelExport.cpp -- that avoided linking
...
// src/editor's own MppModelExport.cpp (MPPMODEL_EXPORT_SPEC.md 5, option 1). This is a deliberate
...
// consuming project, per src/editor/src/MppModelExport.cpp's own comment). Reopening a model-tool-
