...
//
// The AssImp walk itself now lives in src/model-io (modelio::importAsset); this is an adapter from
...
// channel -- both matching src/core's RenderVertex/GeometryBatch conventions.
