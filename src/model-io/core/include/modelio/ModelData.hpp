...
// it is the type the editor's UI and src/core's own baked tox::GeometryBatch conversion both touch,
...
struct Vertex {
  ...
  // xyz = tangent, w = handedness (+1/-1), matching the convention src/tungsten-monoxide's
