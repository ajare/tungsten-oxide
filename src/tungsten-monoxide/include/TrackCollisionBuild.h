...
// src/app/tools/mesh_physics_diag.cpp (DRIVABLE_MESH_OBJECTS_PLAN.md Milestone 6.0's headless
...
// src/model-xml (which this DLL deliberately doesn't link -- see that plan's architecture notes on
...
// meshes' own Type/Visible metadata -- superseding src/model-tool's old CollidableFlag.hpp
...
// src/app/tools/mesh_physics_diag.cpp keep working unchanged: it builds a collision surface straight
...
// caller with no Resources.yaml to read (src/app/tools/mesh_physics_diag.cpp) can derive the same
