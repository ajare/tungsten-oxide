...
- **ModelConvert** (`ext/willpower/ext/massive-poly-pusher/model-convert`) — the existing
...
- **AssImpModelLoader** (`ext/willpower/ext/massive-poly-pusher/model-convert/include/
