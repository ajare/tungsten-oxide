// MaterialXmlImport.hpp — reads a Resources.xml-shaped file (the same shape
// ModelResourceExport.hpp writes, and the shape cpp/tungsten-monoxide/resources/Resources.xml
// uses) looking for <Resource type="Material"> entries, resolving each one's dependent "Texture"
// resource down to a real image file path.
//
...
// chain), this walks Material -> Image directly, one level shallower, matching the shape
// buildModelMaterialsXml itself emits.
#pragma once
