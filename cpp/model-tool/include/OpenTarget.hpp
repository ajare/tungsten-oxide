...
// one embedded <Model> element by id. Deliberately independent of cpp/editor's own
...
// parsing independently" convention -- see cpp/tungsten-monoxide's own wp::XmlNode parser).
#pragma once
