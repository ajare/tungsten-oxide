...
ProtoEntity::ProtoEntity(string const& name,
    ...
    : application::resourcesystem::Resource(name, namesp, "ProtoEntity", source, tags, location), mEntityHandler(entityHandler) {
}

void ProtoEntity::loadExtraDefinitions(DataNode* node, entt::entity protoId) {
