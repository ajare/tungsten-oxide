...
namespace applib
{
	...
	void ProtoEntityResourceDefinitionFactory::loadExtraDefinitions(ProtoEntity* resource, XmlNode* node, entt::entity protoId)
	{
	...
	void ProtoEntityResourceDefinitionFactory::create(application::resourcesystem::Resource* resource, application::resourcesystem::ResourceManager* resourceMgr, XmlNode* node)
	{
