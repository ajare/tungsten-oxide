...
namespace WP_NAMESPACE
{
	namespace application
	{
		namespace resourcesystem
		{
			...
			void ProgramResourceDefinitionFactory::parseAttribs(ProgramResource* resource, XmlNode* node)
			{
			...
			void ProgramResourceDefinitionFactory::parseMeshSpecificationPrimitiveType(ProgramResource* resource, mpp::mesh::MeshSpecification* meshSpec, XmlNode* node)
			{
			...
			void ProgramResourceDefinitionFactory::parseMeshSpecificationIndexed(ProgramResource* resource, mpp::mesh::MeshSpecification* meshSpec, XmlNode* node)
			{
				WP_UNUSED(resource);
			...
			void ProgramResourceDefinitionFactory::parseMeshSpecificationStorage(ProgramResource* resource, mpp::mesh::MeshSpecification* meshSpec, XmlNode* node)
			{
				auto value = node->getValue();
				StringUtils::toUpper(value);
			...
			void ProgramResourceDefinitionFactory::parseMeshSpecificationBuffer(ProgramResource* resource, mpp::mesh::VertexBufferAttributeLayout* layout, XmlNode* node)
			{
			...
			void ProgramResourceDefinitionFactory::parseMeshSpecification(ProgramResource* resource, XmlNode* node)
			{
