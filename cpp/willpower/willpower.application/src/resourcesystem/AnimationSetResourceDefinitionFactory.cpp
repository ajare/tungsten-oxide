...
namespace WP_NAMESPACE
{
	namespace application
	{
		namespace resourcesystem
		{
			...
			AnimationSetResource::LoopStyle AnimationSetResourceDefinitionFactory::parseLoopStyle(AnimationSetResource* resource, string const& animation, XmlNode* node)
			{
				string loopStyle;
			...
			void AnimationSetResourceDefinitionFactory::parseFrame(AnimationSetResource const* resource, AnimationSetResource::Frame* frame, XmlNode* node)
			{
				string timeStr;
			...
			void AnimationSetResourceDefinitionFactory::parseTag(AnimationSetResource::Frame* frame, XmlNode* node)
			{
			...
			void AnimationSetResourceDefinitionFactory::checkFrameOverrides(AnimationSetResource* resource, string const& animation, AnimationSetResource::FrameSet* frameset, XmlNode* node, bool requireIndex)
			{
				auto& fs = *frameset;
