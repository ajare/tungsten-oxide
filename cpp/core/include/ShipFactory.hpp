...
// web/js/track-physics.js's applyHandling/createRaceState and web/js/track-game.js's
...
// web/js/track-physics.js's applyHandling.
...
// web/js/track-physics.js's createRaceState, with `now` standing in for the
...
// and arms triggers). Mirror of web/js/track-game.js's createShip + the
...
// Mirror of web/js/track-game.js's buildRoster (minus rebuildCheckpointLights,
