// ModelXml.hpp — the <Model> XML fragment schema shared by cpp/editor and cpp/model-tool
...
// (matching cpp/editor/src/TrackResourceDocument.cpp's own convention) rather than returning an
// error code.
#pragma once
