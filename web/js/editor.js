...
// Repo layout: assets/ lives at the repo root, one level above web/ (where this page and
// editor.html both live) -- see CLAUDE.md's "What this is". This path is stored verbatim as
// TextureAsset.path (both here and in cpp/editor/src/TexturePanel.cpp's native equivalent) and
// used directly as a browser URL (loadBundledTextureAssets below, track-game.js's texture loader,
// and this file's own texture-panel <img> preview), so cpp/editor/src/TextureCache.cpp's
// resolution base was updated to match (repoRoot/web, not repoRoot) when this moved.
